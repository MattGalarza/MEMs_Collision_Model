...
@with_kw mutable struct Params{T<:Real}
    ...
    c::T = 1.0  # Film scale: PHYSICAL default (UDE calibrates later)
    c1::T = 0.05  # Optional shuttle damping (Eq. 1 omission; 0 = off)
    ...
    h_eff::T = 50e-9  # Residual contact air gap (single parameter)
    epsc::T = 2e-9  # Sealing-transition width for the Fe derivative
